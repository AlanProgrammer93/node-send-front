...
const Dropzone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta('No se pudo subir, el limite es 1MB, obten una cuenta para mas beneficios.');
    }
                    ...
                    <input className="h-100 " { ...getInputProps() } />
                    ...
                    
                        {
                            ...
                            <div className="text-center">
                                <p className="text-2xl text-center text-gray-600">Selecciona un archivo</p>
